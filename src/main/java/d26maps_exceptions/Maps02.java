...
// kodunuzu okuyan diğer geliştiricilere ve size daha net bilgi verir.
       ...
       //Boolean return ederler
        ...
        System.out.println(b);//true cunku 19 var

        System.out.println(stdAges.containsKey("TOM"));//false cunku buyuk kucik harf duyarli
        System.out.println(stdAges.containsKey("Tom"));//true

      //-------------------------------------------------
        //BUYUK KUCK HARFE DUYARSIZ YAPMA -
        ...
        String emoji1 = "\uD83D\uDC9E";
        System.out.println("Emoji :" + emoji1);
