...
//1)Write the code that checks whether all “averageScore” is greater than 91
       ...
       //2)Write the code that checks whether the number of students in all courses is greater than 100.
        ...
        boolean result4 = coursesList.stream().anyMatch(t->t.getCourseName().contains("Turkishx"));
        ...
        boolean result5 =coursesList.stream().anyMatch(t->t.getSeason().contains("Summer"));
        ...
        boolean result6 = coursesList.stream().noneMatch(t->t.getSeason().contains("Fall"));
        ...
        boolean result7 = coursesList.stream().noneMatch(t->t.getCourseName().contains("German"));
        ...
        System.out.println(name1);//Turkish Night
             ...
             //2.yol max methodu
        String name2  = coursesList.stream().
                max(Comparator.comparing(Course::getAvarageScore)).
                get().
                getCourseName();
        System.out.println(name2);//Turkish Night
        ...
        System.out.println(myList); //[Course{season='Summer', courseName='Turkish Day', avarageScore=97, numberOfSudents=128},
                                    // Course{season='Winter', courseName='Turkish Night', avarageScore=98, numberOfSudents=154}]

        //2.yol
        //List<Course>myList1 = coursesList.stream().sorted(Comparator.comparing(Course::getAvarageScore)).skip().toList();
        ...
        List<Course>courseListSorted = coursesList.stream().
