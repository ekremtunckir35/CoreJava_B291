...
*/
        ...
        //Array Olusturmak
        String[]stdNames1= new String[3]; //en cok kullanilan stil
        //String stdNames2[] = new String[4];
        //System.out.println(stdNames1);// javada Array ler dogrudan yazdirilamaz.
        ...
        //index mantigi ile ekleniyor.0 ilk index demektir.
        names[0]="Ali Can";
        names[2]="Veli Han";
        names[1]="Ayse Hanim";
        System.out.println(Arrays.toString(names));
    ...
    //Bir veriyi gormek icin ise;ornek 1.index te kim var
