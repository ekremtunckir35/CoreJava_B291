...
//Example 1: Ask the user for their age and print it to the console.
        ...
        //Sysytem.in  (standart giris) uzerinden klavyeden giris okunur
        ...
        //3.adim---->olusturdugiumuz object uzerinden uygun method ile kullanicinin girdigi veriyi alip,
        // memory e yerlestirme

        byte age = input.nextByte();//

        System.out.println("girien yas :"  + age);
